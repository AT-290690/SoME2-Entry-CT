...
const clickEdges = e => {
  ...
  elements.commentsSection.innerHTML =
    comment !== null && comment !== void 0 ? comment : '';
...
const clickNodes = e => {
  ...
  elements.commentsSection.innerHTML =
    (_c = current.comment) !== null && _c !== void 0 ? _c : '';
...
const invertAllEdges = () =>
  cy.edges().forEach(edge => {
    const _a = edge.data(),
      { target, source, label } = _a,
      rest = __rest(_a, ['target', 'source', 'label']);
...
const seedGraph = (nodes, edges) => {
  (edges === null || edges === void 0 ? void 0 : edges.length)
    ? cy.add([...nodes, ...edges])
    : cy.add([...nodes]);
};
...
const rules = [...document.getElementsByTagName('rules')].map(el =>
  el.textContent
    .trim()
    .split(',')
    .filter(Boolean)
...
const applyRules = () => {
  var _a;
  memo.ruleBook =
    (_a = rules[lesson.interface.index]) !== null && _a !== void 0 ? _a : [];
};
const displayLesson = () => {
  applyRules();
  ...
  const loadFile = () => {
    ...
    reader.onload = e =>
      __awaiter(void 0, void 0, void 0, function* () {
        return graphFromJson(JSON.parse(e.target.result.toString()));
      });
